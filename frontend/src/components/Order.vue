<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="OrderAcceptyn" v-model="value.orderAcceptyn" :editMode="editMode"/>
            <String label="DeliveryState" v-model="value.deliveryState" :editMode="editMode"/>
            <Number label="CookId" v-model="value.cookId" :editMode="editMode"/>
    ...
    export default {
        ...
        methods: {
            ...
            async selectMenu() {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['selectmenu'].href))
