<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="OrderAcceptyn" v-model="item.orderAcceptyn" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="DeliveryState" v-model="item.deliveryState" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="CookId" v-model="item.cookId" :editMode="editMode" @change="change" />
            </div>
            <div>
