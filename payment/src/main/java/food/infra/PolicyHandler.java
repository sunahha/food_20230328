...
public class PolicyHandler {
    ...
    public void wheneverOrderedMenu_PayAOrder(
        @Payload OrderedMenu orderedMenu
    ) {
        OrderedMenu event = orderedMenu;
        System.out.println(
            "\n\n##### listener PayAOrder : " + orderedMenu + "\n\n"
        );

        // Sample Logic //
        Payment.payAOrder(event);
    }
    ...
    public void wheneverCanceledMenu_PayAOrder(
        @Payload CanceledMenu canceledMenu
    ) {
        CanceledMenu event = canceledMenu;
        System.out.println(
            "\n\n##### listener PayAOrder : " + canceledMenu + "\n\n"
        );
